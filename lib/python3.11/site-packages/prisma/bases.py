...
class BaseLogin(_PrismaModel):
    __prisma_model__: ClassVar[Literal['Login']] = 'Login'

    @classmethod
    def prisma(cls: Type[_PrismaModelT]) -> 'actions.LoginActions[_PrismaModelT]':
        from .client import get_client

        return actions.LoginActions[_PrismaModelT](get_client(), cls)

...
SCHEMA_PATH = Path('/Users/nick/school/Year3/Sem2/src/CIS4360/project/backend/prisma/schema.prisma')
PACKAGED_SCHEMA_PATH = Path(__file__).parent.joinpath('schema.prisma')
ENGINE_TYPE: EngineType = EngineType.binary
BINARY_PATHS = BinaryPaths.parse_obj({'queryEngine': {'darwin-arm64': '/Users/nick/.cache/prisma-python/binaries/4.10.1/aead147aa326ccb985dcfed5b065b4fdabd44b19/node_modules/prisma/query-engine-darwin-arm64'}, 'introspectionEngine': {}, 'migrationEngine': {}, 'libqueryEngine': {}, 'prismaFmt': {}})
...
class Prisma:
    ...
    login: 'actions.LoginActions[models.Login]'
    ...
    def __init__(
        ...
        *,
        ...
        self.login = actions.LoginActions[models.Login](self, models.Login)
    ...
    def _default_datasource(self) -> DatasourceOverride:
        return {
            'name': 'db',
            'url': OptionalValueFromEnvVar(**{'value': 'file:../data.db', 'fromEnvVar': None}).resolve(),
        }
...
class Batch:
    ...
    def __init__(self, client: Prisma) -> None:
        ...
        self.login = LoginBatchActions(self)
